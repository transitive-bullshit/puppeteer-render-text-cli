...
module.exports = async (argv) => {
  program
    ...
    .option('--font-family <string>', 'font-family to add to style')
    .option('--font-size <string>', 'font-size to add to style')
    .option('--padding <string>', 'padding to add to style')
    .option('--color <string>', 'color to add to style')
    .parse(argv)
